window.onload = function() {
    ...
    const defaultLiffId = "1655538891-g5aoYrk2";   // change the default LIFF value if you are not using a node server
...
function registerButtonHandlers() {
    document.getElementById('liffLoginButton').addEventListener('click', () => {
        if (!liff.isLoggedIn()){
            liff.login();
        }
    })
